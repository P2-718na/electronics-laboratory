...
\date{\today}
\title{Misura della caratteristica di uscita di un BJT P-N-P con configurazione a emettitore comune}
%---------------------------------------------------------------------------------------
\begin{document}
    ...
    \input{0-abstract.tex} %todo
    % \end{@twocolumnfalse}
    %]

    \input{1-introduzione.tex} %todo
    \input{2-apparato.tex}
    \input{3-risultati.tex} %todo
    \input{4-conclusioni.tex} %todo
    \input{5-appendici.tex}
