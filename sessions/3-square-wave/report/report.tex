...
\date{\today}
\title{Realizzazione di un'approssimazione di un'onda quadra tramite un circuito tosatore a due livelli}
%---------------------------------------------------------------------------------------
\begin{document}
    ...
    \input{1-introduzione.tex}
    \input{2-apparato.tex}
    \input{3-risultati.tex}
    \input{4-conclusioni.tex}
