...
\begin{center}
  \textbf{\huge Misura della caratteristica I-V di due diodi a semiconduttore \\}
...
\section{Incertezze strumentali}\label{sec:incertezze-strumentali}
  \subsection{Incertezze per l'oscilloscopio}\label{sec:incertezze-oscilloscopio}
  ...
  \subsection{Incertezze per il multimetro}\label{sec:incertezze-multimetro}
